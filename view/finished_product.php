...
if (session_status() == PHP_SESSION_NONE) {
    ...
    if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== "true") {
        header("Location: https://boq.sapphirebh.com/view/signin.php");
...
.custom-font{
   ...
   <style>
         .sidenav{background-color:#111;height:100%;left:0;overflow-x:hidden;padding-top:60px;position:fixed;top:0;transition:.5s;width:0;z-index:1;}
.sidenavR1{background-color:#d9d9d9;height:100%;overflow-x:hidden;padding-top:60px;position:fixed;right:0;top:0;transition:.5s;width:0;z-index:1;}
...
.sidenav .closebtn,.sidenavR1 .closebtn{font-size:36px;margin-left:55px;position:absolute;right:25px;top:55px;}
@media screen and max-height 450px {
.sidenav,.sidenavR1{padding-top:15px;}
.sidenav a,.sidenavR1 a{font-size:18px;}
}
...
.custom-font{
    ...
    will-change: bottom, opacity;
      ...
      <style>
         .sidenav{background-color:#111;height:100%;left:0;overflow-x:hidden;padding-top:60px;position:fixed;top:0;transition:.5s;width:0;z-index:1;}
.sidenavR2{background-color:#d9d9d9;height:100%;overflow-x:hidden;padding-top:60px;position:fixed;right:0;top:0;transition:.5s;width:0;z-index:1;}
...
.sidenav .closebtn,.sidenavR2 .closebtn{font-size:36px;margin-left:55px;position:absolute;right:25px;top:55px;}
@media screen and max-height 450px {
...
.custom-font{
 ...
 width: auto;
  ...
  scrollbar-width: thin;
           ...
           <style>
         .sidenav{background-color:#111;height:100%;left:0;overflow-x:hidden;padding-top:60px;position:fixed;top:0;transition:.5s;width:0;z-index:1;}
.sidenavR3{background-color:#d9d9d9;height:100%;overflow-x:hidden;padding-top:60px;position:fixed;right:0;top:0;transition:.5s;width:0;z-index:1;}
.sidenav a,.sidenavR3 a{color:#818181;display:block;font-size:25px;padding:8px 8px 8px 32px;text-decoration:none;transition:.3s;}
.sidenav a:hover,.offcanvas a:focus,.sidenavR3 a:hover,.offcanvas a:focus{color:#f1f1f1;}
.sidenav .closebtn,.sidenavR3 .closebtn{font-size:36px;margin-left:55px;position:absolute;right:25px;top:55px;}
@media screen and max-height 450px {
.sidenav,.sidenavR3{padding-top:15px;}
.sidenav a,.sidenavR3 a{font-size:18px;}
}
...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/finished_product_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/finished_product_body.php')?>
        <!-- content page ends -->
 ...
 <script src="vendor/dropify/js/dropify.min.js"></script>
   ...
   <!-- User script file -->
    ...
    <script src="../httpdocs/user_js/finished_product.js"></script>
    
    <script>
    "use script";
        $('.chosen_select').chosen();
        // $('#select_product_type').chosen();
    ...
    width: "95%"
       ...
       $('#select_project_name_material_chosen').chosen({
        width: '100%' // or '300px'
    });
 ...
 function openNavR1() {
        document.getElementById("mySidenavR1").style.width = "85%";
        //$('#req_serial_no').html($('#txt_requisition_serial_no').val());
    }
function openNavR2() {
        document.getElementById("mySidenavR2").style.width = "85%";
        //$('#req_serial_no').html($('#txt_requisition_serial_no').val());
    }
    function openNavR3() {
        document.getElementById("mySidenavR3").style.width = "85%";
        //$('#req_serial_no').html($('#txt_requisition_serial_no').val());
    }
    function closeNavR() {
    ...
    function closeNavR3() {
        document.getElementById("mySidenavR3").style.width = "0";
    } 
  </script>
