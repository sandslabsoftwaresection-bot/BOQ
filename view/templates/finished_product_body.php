                            ...
                            <hr>
                              <div class="form-group row">
                                   ...
                                   <div class="col-lg-12" style="padding-bottom:10px;">
                                    ...
                                    <button type="button" class="btn btn-link p-0 chat-close vm header-color-secondary" id="btn_view_refresh_items"  style="padding-left: 10px;" title="View All Items">
                                        <span class="material-icons">refresh</span>
                                    </button>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 me-2" id="div_item_select">
                                            <select class="chosen_select form-control form-control-sm" id="select_item_name" name="select_item_name" data-live-search="true" aria-hidden="true">
                                                <option value="select">Select Item</option>
                                            </select>
                                        </div>
                                        <button id="btn_add_item" class="btn btn-primary">Add</button>
                                        <input type="hidden" id="txt_store_id" class="form-control form-control-sm" placeholder="">
                                        <button type="button" class="btn btn-link p-0 chat-close vm header-color-secondary" id="btn_view_list_of_store" onclick="openNavR()" style="padding-left: 10px;" title="View List of Store">
                                  ...
                                  <div class="col-lg-2 col-md-2">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group mb-1" id="div_equipment_cost">
                                            ...
                                            <input type="number" id="txt_euipment_cost" value="5" class="form-control form-control-sm" placeholder="" style="text-align:right;">
                                 ...
                                 <div class="col-lg-2 col-md-2">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group mb-1" id="div_other_cost">
                                            ...
                                            <input type="number" id="txt_other_cost" value="5" class="form-control form-control-sm" placeholder="" style="text-align:right;">
                                    ...
                                    <div class="form-group">
                                       <label>Margin</label>
                                        ...
                                        <div class="input-group mb-1" id="div_margin_cost">
                                            ...
                                            <input type="number" id="txt_margin_cost" value="20" class="form-control form-control-sm" placeholder="" style="text-align:right;">
                        ...
                        <div class="col-md-10 ">
                            <div class="form-group row">
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div id="div_company_select_material" style="width:100%">
                                    <select class="chosen_select form-control " id="select_company_material" style="width: 100%;" tabindex="1" >
                                               
                                               
                                             
                                     </select>
                                    </div>
                                    <input type="hidden" class="form-control form-control-sm" id="txt_product_company_id_material">
                                ...
                                <div class="col-lg-4 col-md-4">
                                        ...
                                        <div id="div_project_select_material" style="width:100%">
                                    
                                    
                                          
                                  
                                           <select class="chosen_select form-control form-control-sm" id="select_project_name_material" tabindex="-1" style="width: 100%;" name="select_project_name_material" >
                               ...
                               <!-- </div>-->
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2" style="padding-top:29px">
                                        <button class="btn btn-info" id="btn_view_estimation_list"> <i class="material-icons">search</i> </button>
                                    </div>
                            </div>
...
<!-----Modal For Add Item -->
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="modal_add_item">
    <div class="modal-dialog modal-xl" role="document"> <!-- Use modal-lg for a larger modal -->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" id="btn_top_reissue_close" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.978) 100%);">
                        <h5 class="time-title mb-0 text-white">New Store Details</h5>
                        <p class="mb-0 text-white">Fill in the details below<span class="status bg-success"></span></p>
                    </div>
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-lg-6 ">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <label>Category <st style="color:red">*</st></label>
                                            <input  type="text" class="form-control form-control-sm" id="txt_category_name">
                                            <input  type="hidden" class="form-control form-control-sm" id="txt_category_val">
                                    </div>
                                    <div class="col-lg-12 col-md-12" style="padding-top:10px">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div id="div_primary_unit_select">
                                            <select class="form-control form-control-sm" id="select_primary_unit" data-live-search="true" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="col-lg-12 col-md-12" style="padding-top:10px">
                                        ...
                                        <input type="number" id="txt_rate_per_unitt" class="form-control form-control-sm" placeholder="">
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <label>VAT % <st style="color:red">*</st></label>
    									<input type="text" id="txt_vat_perc" value="10.000" class="form-control form-control-sm" placeholder="">
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <input type="number" id="txt_vat_amountt" class="form-control form-control-sm"   placeholder="" readonly>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12 col-md-12" style="padding-bottom:10px">
                                        ...
                                        <div id="div_secondary_unit_select">
                                            <select class="form-control form-control-sm" id="select_seconadry_unit" data-live-search="true" tabindex="-1" aria-hidden="true"></select>
                                        </div>
                                    </div> 
                                    <div class="col-lg-12 col-md-12"  id="div_length_modal">
                                        <label>Length of the Material</label>
                                        <input type="number" id="text_length" value="0" class="form-control form-control-sm" min="0" placeholder="">
                                    </div>
                                    <div class="col-lg-12 col-md-12" id="div_width_modal">
                                        <label>Width of the Material</label>
                                        <input type="number" id="text_width" value="0" class="form-control form-control-sm" placeholder="">
                                    </div>
                                    <div class="col-lg-12 col-md-12" id="div_thickness_modal">
                                        <label>Height of the Material  </label>
                                        <input type="number" id="text_thickness" value="0" class="form-control form-control-sm" placeholder="">
                                    </div>
                                    <div class="col-lg-12 col-md-12" id="div_weight_modal">
                                        <label>Weight of the Material (meter/ Kg)  </label>
                                        <input type="number" id="text_weight" value="0" class="form-control form-control-sm" placeholder="">
                                    </div>
                                    <div class="col-lg-12 col-md-12" id="div_height" style="display:none">
                                        <input type="hidden" id="text_height" value="0" class="form-control form-control-sm" placeholder="">
                                    </div>
                              
                              
                                    <div class="col-lg-12 col-md-12" id="div_square_meter_modal">
                                        <label>Square Meter </label>
                                        <input type="number" id="text_square_meter" value="0" class="form-control form-control-sm" placeholder="" readonly>
                                    </div>
                                    <div class="col-lg-12 col-md-12" id="div_cubic_meter_modal">
                                        <label>Cubic Meter </label>
                                        <input type="number" id="text_cubic_meter" value="0" class="form-control form-control-sm" placeholder="" readonly>
                                    </div>
                                    <div class="col-lg-12 col-md-12" id="div_total_weight_modal">
                                        <label>Total Weight of the Material</label>
                                        <input type="number" id="text_total_weight" value="0" class="form-control form-control-sm" placeholder="" readonly>
                                    </div> 
                                    <div class="col-lg-12 col-md-12" >
                                        <label>Rate Per Unit Category Base</label>
                                        <input type="number" id="text_secondary_rate_per_unit" class="form-control form-control-sm" placeholder="">
                                    </div> 
                                    <div class="col-lg-12 col-md-12">
                                        <label>Amount</label>
                                        <input type="number" id="text_secondary_amount" value="0.000" class="form-control form-control-sm" placeholder="" readonly>
                                    </div> 
                                </div>  
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btn_remarks_close">Close</button>
                <button type="button" class="btn btn-primary" id="btn_item_save">Save</button>
            </div>
        </div>
    </div>
</div>
