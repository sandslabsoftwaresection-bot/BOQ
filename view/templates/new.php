                    ...
                    <div class="media w-100 ">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <!--    <a href="" class="dropdown-item">New</a>-->
                                <button  class="btn btn-sm btn-outline-light" onclick="openNavR()" id="btn_view_list_of_products">List of Product Details</button>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10 ">
                            ...
                            <div class="form-group row">
                                 ...
                                 <div class="col-lg-4 col-md-4" tabindex="3">
                              ...
                              <div class="col-lg-8 col-md-8" >
                                <div   class="row" >
                                     ...
                                     <div class="col-lg-6 col-md-6" id="new_product_code" tabindex="4">
                                ...
                                <div class="col-lg-6 col-md-6" id="new_product_name">
                                 ...
                                 <!--<div class="col-lg-12 col-md-12" id="existing_product"  style="display:none" tabindex="5">-->
                                   <div class="col-lg-12 col-md-12" id="existing_product" style="display:none"> 
                                    <label>Product</label>
                                  
                                    <select id="select_product_type" class="chosen_select form-control form-control-sm" data-live-search="true" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="form-group row">
                                 <div class="col-lg-4">
                                            ...
                                            <select class="chosen_select form-control " id="select_category_name" name="select_category_name" data-live-search="true" tabindex="-1" aria-hidden="true">
                                 ...
                                 <div class="col-lg-1 col-md-1" style="align:right;padding-left:2px;padding-top:7px" >
                                  <br>  
                                ...
                                <span class="material-icons">view_list</span>
                                 ...
                                 <div class="col-lg-2 col-md-2">
                                    ...
                                    <input type="number" id="txt_required_qty" class="form-control form-control-sm" placeholder="">
                                </div>
                            ...
                            <div class="form-group row">
                                  ...
                                  <div class="col-lg-2 col-md-2">
                                    <label>Length </label>
                                    <input type="number" id="txt_length" value="0" class="form-control form-control-sm" placeholder="">
                                ...
                                <div class="col-lg-2 col-md-2">
                                 ...
                                 <div class="col-lg-2 col-md-2">
                                    <label>Height </label>
                                    <input type="number" id="txt_height" value="0" class="form-control form-control-sm" placeholder="">
                                    <span id="error_hght" style="color:red;font-size:90%" ></span>
                                </div>
                                 <div class="col-lg-2 col-md-2">
                       ...
                       <h5 class="m-0">Item Details</h5>
                        ...
                        <!--Table-->
                            ...
                            <!--Table-->
                                ...
                                <tbody>
                                    <!--<tr >-->
                                    <!--    <td class="details-control sorting_1 dtr-control"></td>-->
                                    <!--    <td>1 </td>-->
                                    <!--    <td>Aluminium </td>-->
                                    <!--    <td>Item1 </td>-->
                                    <!--    <td>1 </td>-->
                                    ...
                                    <!--    <td>700</td>-->
                                    <!--    <td>700</td>-->
                                    <!--    <td style=""> <button type="button" class="btn btn-sm btn-danger mr-1" id="delete_item" name="delete_item"><i class="material-icons ">delete</i></button></td>-->
                                    <!--</tr>-->
                                    <!--<tr >-->
                                    <!--    <td class="details-control sorting_1 dtr-control"></td>-->
                                    <!--    <td>2 </td>-->
...
<div id="mySidenavR" class="sidenavR " height="100%" style="background-color:white;padding-top:70px;box-shadow: -10px 0px 10px #e3e3e3;">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0px">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <!--Table-->
                            <table class="table table-striped table-bordered dt-responsive nowrap" id="list_of_stores"  style="padding-top:5px;font-size:12px;width:100%">
                                <thead>
                                    <tr >
