...
?>
 <select  id="select_company_material" name="select_company_material" class="chosen_select form-control form-control-sm" data-live-search="true" style="width: 300px;"   aria-hidden="true"  >
