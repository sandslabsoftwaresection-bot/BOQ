...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/report_bill_of_qty_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/report_bill_of_qty_body.php')?>
        <!-- content page ends -->
   ...
   <!-- User script file -->
    ...
    <script src="../httpdocs/user_js/bill_of_quantity.js"></script>
