...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no, viewport-fit=cover">
     ...
     <!-- favicons -->
    <link rel="apple-touch-icon" href="../../httpdocs/images/company_profile_image/<?php echo $logo_name; ?>">
    <link rel="icon" href="../../httpdocs/images/company_profile_image/<?php echo $logo_name; ?>">
...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/tax_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/tax_body.php')?>
        <!-- content page ends -->
    ...
    <script src="js/main-with-style-switcher.js"></script>
    	 ...
    	 <!-- datatable responsive jquery file -->
  ...
  <script src="https://cdn.datatables.net/responsive/2.2.6/js/responsive.bootstrap4.min.js"></script>
    ...
    <script src="../httpdocs/user_js/tax_entry.js"></script>
    ...
    $(document).ready(function() {    
                ...
                // var invoice_view_list_table = $('#list_of_tax').DataTable( {searching: false, paging: false, info: false,"ordering": false});
