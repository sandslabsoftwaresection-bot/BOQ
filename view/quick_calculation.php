...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/quick_calculation_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/quick_calculator_body.php')?>
        <!-- content page ends -->
 ...
 <script src="vendor/dropify/js/dropify.min.js"></script>
   ...
   <!-- User script file -->
    <script src="../httpdocs/user_js/quick_calculator.js"></script>
	 <!--<script src="../httpdocs/user_js/product_autocomplete.js"></script> -->
