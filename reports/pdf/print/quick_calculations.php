   ...
   //$company_id = $_GET['v_company_id'];
	...
	$result_product_details = mysqli_query($conns,"SELECT * FROM master_finished_quick_product_table WHERE master_finished_quick_id = ".$v_master_prod_id." ");
	  while($row_fetch_product =mysqli_fetch_assoc($result_product_details)) 
	  {
		  ...
		  $product_qty = $row_fetch_product['total_item'];
...
$pdf->AddPage();
			...
			$tot_amount=0;
	            ...
	            $content = $content.'<tr style="'.$border_bottom.';">';
					$content = $content.'    <td colspan="6" style="text-align: left;'.$valign_middle1.$border_bottom.$border_left.';"><strong>Amount</strong></td>';
				...
				$content = $content.'  </tr>';
				 $content = $content.'<tr style="'.$border_bottom.';">';
					$content = $content.'    <td colspan="6" style="text-align: left;'.$valign_middle1.$border_bottom.$border_left.';"><strong>Single Cost Before VAT</strong></td>';
					$content = $content.'    <td  style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';"><strong>'.number_format($result,3).'</strong></td>';
				$content = $content.'  </tr>';
				...
				// $content = $content.'  </tr>';
			$result_material_list = mysqli_query($conns, "SELECT * FROM master_finished_quick_product_table WHERE master_finished_quick_id = ".$v_master_prod_id);
            $tot_amount = 0;
            ...
            while ($row_material_list = mysqli_fetch_assoc($result_material_list)) {
                ...
                $tax = ($rate * $vat / 100) + $rate;
                $amount = $tax * $qty;
                $total_amount += $row_material_list['vat_amount'];
                $tot_amount += $amount;
                $result = $total_amount / $product_qty;
            
                $content_three .= '<tr nobr="true" style="'.$border_bottom.';">';
                $content_three .= '  <td style="text-align: center;'.$valign_middle1.$border_bottom.$border_left.';">'.trim($row_material_list['project_item_primary_amt']).'</td>';
                $content_three .= '  <td style="text-align: center;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($row_material_list['vat_percentage'], 2).'</td>';
                $content_three .= '  <td style="text-align: center;'.$valign_middle1.$border_bottom.$border_left.';">'.$row_material_list['vat_prct_amount'].'</td>';
                $content_three .= '  <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($row_material_list['vat_amount'], 3).'</td>';
                $content_three .= '</tr>';
            
                // Accumulate net amounts for totals
                $amt = $amt + $row_material_list["net_amount"];
                $tot_amt = $tot_amt + $row_material_list["net_amount"];
            }
            
            // Display total material cost
            $content_three .= '<tr style="'.$border_bottom.';">';
            $content_three .= '    <td colspan="3" style="text-align: left;'.$valign_middle1.$border_bottom.$border_left.';"><strong>Material Cost</strong></td>';
            $content_three .= '    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';"><strong>'.number_format($total_amount, 3).'</strong></td>';
            $content_three .= '</tr>';
            
            // Display single cost
            $content_three .= '<tr style="'.$border_bottom.';">';
            $content_three .= '    <td colspan="3" style="text-align: left;'.$valign_middle1.$border_bottom.$border_left.';"><strong>Single Cost After VAT</strong></td>';
            $content_three .= '    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';"><strong>'.number_format($result, 3).'</strong></td>';
            $content_three .= '</tr>';
            ...
            while($row_material_list1 =mysqli_fetch_assoc($result_product_details)) 
            {
			  ...
			  if($labour_cost_type == 'BD')
			  {
				$labour_rate =  $labour_cost;  
				 ...
				 $labour_rate = $total_amount * ($labour_cost/100) ; 
			  }
			  $labour_cost_amt = $total_amount + $labour_rate ;
			  ...
			  $margin_cost_amt = $margin_rate + $other_cost_amt;
			   $resultt = $margin_cost_amt / $product_qty;
		  }
	...
	//------------------------------------------------------------  Content two table ---------------------------------------------------------\\			
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'<td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($total_amount,3).'</td>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($labour_cost_amt,3).'</td>';
				$content_two = $content_two.'  </tr>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($equipment_cost_amt,3).'</td>';
				$content_two = $content_two.'  </tr>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($service_cost_amt,3).'</td>';
				$content_two = $content_two.'  </tr>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($other_cost_amt,3).'</td>';
				$content_two = $content_two.'  </tr>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($margin_cost_amt,3).'</td>';
				$content_two = $content_two.'  </tr>';
				$tot_cost = number_format($margin_cost_amt,3);
			    // Display total material cost
                $content_two .= '<tr style="'.$border_bottom.';">';
                $content_two .= '    <td colspan="3" style="text-align: left;'.$valign_middle1.$border_bottom.$border_left.';"><strong>Total Cost</strong></td>';
                $content_two .= '    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';"><strong>'.number_format($margin_cost_amt, 3).'</strong></td>';
                $content_two .= '</tr>';
                
                // Display single cost
                $content_two .= '<tr style="'.$border_bottom.';">';
                $content_two .= '    <td colspan="3" style="text-align: left;'.$valign_middle1.$border_bottom.$border_left.';"><strong>Single Cost</strong></td>';
                $content_two .= '    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';"><strong>'.number_format($resultt, 3).'</strong></td>';
                $content_two .= '</tr>';
    	...
    	<tr >  
            <td> 
                <table width="100%"  cellspacing="0" cellpadding="3"  style="border-collapse: collapse;border: .7em solid $color;$table_background">
                    <tbody>
                        <tr>
                            <td bgcolor="$table_title_bg" style="width:25%;$table_title_style"><strong>Mt.Cost</strong></td>
                			<td bgcolor="$table_title_bg" style="width:24%;$table_title_style"><strong>VAT(%)</strong></td>
                			<td bgcolor="$table_title_bg" style="width:25%;$table_title_style"><strong>VAT(%) Amt</strong></td>
                			<td bgcolor="$table_title_bg" style="width:25%;$table_title_style"><strong>VAT Total</strong></td>
                        </tr>  
        		        $content_three
        		    </tbody>
        	    </table>
