...
$pdf->AddPage();
			...
			$tot_amount=0;
                    while($row_material_list =mysqli_fetch_assoc($result_material_list)) {
					  ...
					  $tot_amount += $amount; 
                          ...
                          $content = $content.'  <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($tax,3).'</td>';
	            ...
	            $content = $content.'<tr style="border-bottom: 1px solid gray;">';
					$content = $content.'    <td colspan="6" style="text-align: left"><strong>Material Amount</strong></td>';
	...
	//------------------------------------------------------------  Content two table ---------------------------------------------------------\\			
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'<td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.$a.'</td>';
					$content_two = $content_two.'<td colspan="1" style="text-align: center;'.$valign_middle1.$border_bottom.$border_left.';"></td>';
					$content_two = $content_two.'<td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($tot_amount,3).'</td>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($labour_rate,3).'</td>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td colspan="1" style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($equipment_rate,3).'</td>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td colspan="1" style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($service_rate,3).'</td>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td colspan="1" style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($other_rate,3).'</td>';
				...
				$content_two = $content_two.'<tr nobr="true" style="'.$border_bottom.';">';
					...
					$content_two = $content_two.'    <td colspan="1" style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($margin_rate,3).'</td>';
