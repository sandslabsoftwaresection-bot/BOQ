                    ...
                    $($(this)[0].files).each(function () {
                        ...
                        if (regex.test(file[0].name.toLowerCase())) {
                            ...
                            reader.onload = function (e) {
                                var img = $("<img />");
                               img.attr("style", "width:330px;height: 65px");
           ...
           function company_profile()
           {
                ...
                $.post("../controller/company/profile_controller.php",{action:'list_profile'}
                                            ...
                                            //   $('#hidden_front_logo').val(company.data[0].front_logo);
                                               ...
                                               $("#dvPreview").prepend('<img  width="110%" height="50%" src="../../httpdocs/images/company_profile_image/'+$.trim(company.data[0].print_logo)+'"/> ');
