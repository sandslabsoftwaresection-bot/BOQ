$(document).ready(function(){
    ...
    $('#txt_required_qtyy').click(function() {
        var rateUnit = $('#txt_rate_unit').val().trim(); // Get value of txt_rate_unit

        // Check if txt_rate_unit is empty
        if (rateUnit === "") {
            swal("Warning","Please enter a rate in the rate unit field!", "warning");
             return false;
        }
    });
    ...
    $('#txt_required_qtyy').keyup(function () {
        ...
        if (missingFields.length > 0) {
            ...
            $('#txt_required_qtyy').val(''); // Reset quantity
            return false;
        }
