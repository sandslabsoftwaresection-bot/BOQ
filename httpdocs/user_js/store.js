$(document).ready(function(){
                 ...
                 var cubic_meter, square_meter,current_length,current_width,current_thickness;
	...
	$.post("../controller/store/store_controller.php",{action:'fetch_tax' }
		, function(result,status)
		{
			var obj= jQuery.parseJSON(result);
            $("#txt_vat_perc").val(obj.data[0].tax_value);
    ...
    //   });
      ...
      function reinitialize_to_zero()
      {
         ...
         if(current_length == "")
            ...
            //$('#div_total_weight, #div_square_meter, #div_cubic_meter').hide();
       ...
       function change_length()
       {
           reinitialize_to_zero();
            ...
            {
                var square_meter=parseFloat($('#txt_length').val())*parseFloat($('#txt_width').val());
                 $('#div_square_meter').show();
                 $('#txt_square_meter').val(square_meter.toFixed(3));
                 var secamount=parseFloat(square_meter)*parseFloat($('#txt_secondary_rate_per_unit').val());
                $('#txt_secondary_amount').val(secamount.toFixed(3));
            }
            else if ($("#div_secondary_unit_select option:selected").text()=='M3')
            {
                var cubic_meter=parseFloat($('#txt_length').val())*parseFloat($('#txt_width').val())*parseFloat($('#txt_thickness').val());
                $('#div_cubic_meter').show();
                 $('#txt_cubic_meter').val(cubic_meter.toFixed(3));
                  var secamount=parseFloat(cubic_meter)*parseFloat($('#txt_secondary_rate_per_unit').val());
                $('#txt_secondary_amount').val(secamount.toFixed(3));
            }
       ...
       function change_weight()
       {
         ...
         $('#txt_length').change(function (e) {
               reinitialize_to_zero();
               change_length();
           });
           $('#txt_width').change(function (e) {
               reinitialize_to_zero();
               change_width();
           });
           $('#txt_thickness').change(function (e) {
               reinitialize_to_zero();
               change_thickness();
           });
           $('#txt_weight').change(function (e) {
               reinitialize_to_zero();
               change_weight();
           });
           
            $('#txt_secondary_rate_per_unit').change(function (e) {
              if($('#txt_secondary_rate_per_unit').val()=='')
              {
                  $('#txt_secondary_rate_per_unit').val(0.000);
                  $('#txt_secondary_amount').val(0.000);
              }
              else
              {
                ...
                switch(v_sec_unit_name)
                {
                    case 'Kg':
                        ...
                        var secamount=parseFloat($('#txt_total_weight').val())*parseFloat($('#txt_secondary_rate_per_unit').val());
                        $('#txt_secondary_amount').val(secamount.toFixed(3));
                       
                    break;
                    case 'M2':
                        
                       var secamount=parseFloat($('#txt_square_meter').val())*parseFloat($('#txt_secondary_rate_per_unit').val());
                        $('#txt_secondary_amount').val(secamount.toFixed(3));
                        
                    break;
                    case 'M3':
                       
                        var secamount=parseFloat($('#txt_cubic_meter').val())*parseFloat($('#txt_secondary_rate_per_unit').val());
                        $('#txt_secondary_amount').val(secamount.toFixed(3));
       ...
       function calculate_total_weight()
       {
              ...
              $('#txt_item_code').change(function (e) {
			   ...
			   $("#txt_vat_perc").change(function() { 
				  ...
				  v_primary_rate_per_unit=$("#txt_rate_per_unit").val();
                    ...
                    var total_amount=(parseFloat($('#txt_vat_amount').val())+parseFloat($("#txt_rate_per_unit").val()));
                    $("#txt_amount").val((total_amount.toFixed(3)));
					//alert(vat+ '' + txt_vat_amount + ' ' +total_amount);
			   }); 
        ...
        function format(d)
		{
			...
			return '<table style="table-layout: fixed; width: 100%; word-wrap: normal;">'+
			...
			'</table>' ;
                ...
                //                  { "data": "state"},
                 ...
                 $('#list_of_stores tbody').on('click', 'td button', function(){
                    ...
                    $("#txt_secondary_rate_per_unit").val("");
                     ...
                     $("#div_category_select").find('option').removeAttr("selected");
                        $('#div_category_select option').map(function () {
                            // Remove white space from data.category_name
                            var trimmedCategoryName = data.category_name.trim();
                            if ($(this).text().trim() === trimmedCategoryName) return this;
                   ...
                   $("#txt_item_code").val(data.item_code);
                    ...
                    $("#txt_vat_perc").val(data.vat_percentage);
                     ...
                     switch(data.sec_unit_name)
                {
                    case 'Kg':
                        ...
                        $('#div_width, #div_thickness, #div_height, #div_square_meter, #div_cubic_meter').hide();
                        $('#div_length, #div_weight, #div_total_weight').show();
                         var secamount=parseFloat(tot_weight)*parseFloat(data.sec_rate_per_unit);
                        $('#txt_secondary_amount').val(secamount.toFixed(3));
                    ...
                    case 'M2':
                       ...
                       var square_meter=parseFloat($('#txt_length').val())*parseFloat($('#txt_width').val());
                        ...
                        $('#div_thickness, #div_weight, #div_height, #div_total_weight, #div_cubic_meter').hide();
                        $('#div_width, #div_length, #div_square_meter').show();
                         var secamount=parseFloat(square_meter)*parseFloat(data.sec_rate_per_unit);
                        $('#txt_secondary_amount').val(secamount.toFixed(3));
                    ...
                    case 'M3':
                        ...
                        $('#div_weight, #div_height, #div_total_weight, #div_square_meter').hide();
                        $('#div_length, #div_width, #div_thickness, #div_cubic_meter').show();
                         var secamount=parseFloat(cubic_meter)*parseFloat(data.sec_rate_per_unit);
                        $('#txt_secondary_amount').val(secamount.toFixed(3));
             ...
             $('#session_image').change(function(){
                 ...
                 var doc_file_obj = $("#session_image")[0].files[0];
                  ...
                  v_btn_store_edit.click(function(){
                    ...
                    if($.trim(v_category_id)=="0"||$.trim(v_category_name)=="Select Category"||$.trim(v_item_name)==""||$.trim(v_unit_id)=="0"||$.trim(v_primary_rate_per_unit)==""||$.trim(v_tax_percentage)==""||$.trim(txt_precision)=="")
                    ...
                    {         
                         $.post("../controller/store/store_controller.php",{action:'update_store_details',category_id:v_category_id,category_name:v_category_name,v_item_name:v_item_name,v_unit_id:v_unit_id,v_unit_name:v_unit_name,v_primary_rate_per_unit:v_primary_rate_per_unit,v_tax_percentage:v_tax_percentage,v_vat_amount:v_vat_amount,v_txt_amount:v_txt_amount,v_txt_precision:v_txt_precision,v_txt_length:v_txt_length,v_txt_width:v_txt_width,v_txt_height:v_txt_height,v_txt_thickness:v_txt_thickness,v_txt_weight:v_txt_weight,v_sec_unit_id:v_sec_unit_id,v_sec_unit_name:v_sec_unit_name,v_total_weight:v_total_weight,v_txt_secondary_rate_per_unit:v_txt_secondary_rate_per_unit,upload_item_image:v_session_image ,v_store_id:v_store_id,square_meter:v_square_meter,cubic_meter:v_cubic_meter }
                                , function(result,status)
                                {
