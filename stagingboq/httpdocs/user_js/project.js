$(document).ready(function(){
               ...
               function formatDate(date) {
                ...
                v_btn_add_project.click(function(){
                    ...
                    v_tax_id=$("#div_tax_select option:selected").val();
                    v_tax_name=v_tax_details[0];
                    v_tax_amount=v_tax_details[1];
                  
            
                    if($.trim(v_company_name)==""||$.trim(v_company_id)=="0"||$.trim(v_project_name)==""||$.trim(v_tax_id)=="0")
                    ...
                    {         
                         $.post("../controller/project/project_controller.php",{action:'add_project',v_company_id:v_company_id,v_company_name:v_company_name,v_project_name:v_project_name,v_tax_id:v_tax_id,v_tax_name:v_tax_name,v_tax_value:v_tax_amount}
                     ...
                     function  edit_data(v_project_id) 
                       {
                        ...
                        //alert(data.company_name);
                         $("#div_company_select").find('option').removeAttr("selected");
                        ...
                        if ($(this).val() == data.tax_id) return this;
                        }).attr('selected', 'selected');
                  ...
                  v_btn_edit_project.click(function(){
                    ...
                    {         
                        ...
                        //         , function(result,status)
                                ...
                                $.post("../controller/project/project_controller.php",{action:'edit_project',v_project_id:v_project_id,v_company_id:v_company_id,v_company_name:v_company_name,v_project_name:v_project_name,v_tax_id:v_tax_id,v_tax_name:v_tax_name,v_tax_value:v_tax_amount}
                                , function(result,status)
