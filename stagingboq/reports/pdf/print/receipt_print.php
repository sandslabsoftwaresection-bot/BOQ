...
$pdf->AddPage();
						...
						$content = $content .'<table width="100%" border="0" cellspacing="0" cellpadding="10">';
						...
						//$content = $content .'<td style="text-align: center; border-bottom: 1pt solid black;"></td>';
						$content = $content .'<td style="border-bottom: 1pt solid black;width:210px;">Date : <strong>' . $receipts_date . '</strong></td>';
						$content = $content .'</tr>';
						$content = $content .'</tbody>';
						...
						$content = $content . '<td width="75%" align="left" valign="middle" style="text-align: left; border-bottom: 1pt solid black;"><strong>'.$received_from.'</strong></td>';
						$content = $content . '</tr>';
						$content = $content . '</tbody>';
						...
						$content = $content . '<td width="21%" style="border-bottom: 1pt solid black;">' . $bank . '</td>';
						...
						$content = $content . '<table width="100%" border="0" cellspacing="0" cellpadding="5">';
						$content = $content . '<tbody>';
						$content = $content . '<tr>';
						$content = $content . '<td width="24%" style="padding-left: 0px;">The Sum of BD.</td>';
						$content = $content . '<td width="76%" style="border-bottom: 1pt solid black;"><strong>';
						$splitamount = explode('.', $total_amount);
						if (intval($splitamount[1]) <= 0) {
							$content = $content . getCurrency($splitamount[0]) . ' only';
						} else {
