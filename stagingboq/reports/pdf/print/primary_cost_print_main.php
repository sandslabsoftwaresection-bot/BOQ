			...
			$tot_amount=0;
                    ...
                    while($row_material_list =mysqli_fetch_assoc($result_primary_cost)) {
					  ...
					  $tot_amount += $amount; 
                          ...
                          $content = $content.' <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format(($row_material_list['labour_cost_type'] == 'BD') ?($row_material_list['product_primary_amt'] * $row_material_list['labour_cost'] / 100) :$row_material_list['labour_cost_amt'],3,".",",") .'</td>';
                          $content = $content.' <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format(($row_material_list['service_cost_type'] == 'BD') ?($row_material_list['product_primary_amt'] * $row_material_list['service_cost'] / 100) :$row_material_list['service_cost_amt'],3,".",",") . '</td>';
                          $content = $content.' <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format(($row_material_list['equipment_cost_type'] == 'BD') ?($row_material_list['product_primary_amt'] * $row_material_list['equipment_cost'] / 100) :$row_material_list['equipment_cost_amt'],3,".",",") . '</td>';
                          $content = $content.' <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format(($row_material_list['other_cost_type'] == 'BD') ?($row_material_list['product_primary_amt'] * $row_material_list['other_cost'] / 100) :$row_material_list['other_cost_amt'],3,".",",") . '</td>';
                          $content = $content.' <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format(($row_material_list['margin_cost_type'] == 'BD') ?($row_material_list['product_primary_amt'] * $row_material_list['margin_cost'] / 100) :$row_material_list['margin_cost_amt'],3,".",",") . '</td>';
                          ...
                          $content = $content.' <td style="text-align: right;'.$valign_middle1.$border_bottom.$border_left.';">'.number_format($row_material_list['total_amnt_after_vat'],3,".",",").'</td>';
		   ...
		   <td width="49%" align="left" valign="top" style="padding-bottom: 0px;"></td>
				<td align="left" valign="top" >
					<table width="100%"  cellspacing="0" cellpadding="5">
						<tbody>
							<tr >
							  <td style="text-align: center; color: #FFFFFF; font-size: 26px; " bgcolor="$table_title_bg">PRIMARY COST SHEET</td>
							</tr>
      ...
      <td>
        ...
        <tbody>
          <tr>
			...
			<td bgcolor="$table_title_bg" style="width:7%;$table_title_style"><strong>Tot. Amt</strong></td> 
          </tr>  
