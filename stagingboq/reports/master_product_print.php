...
require ('../model/db_connection/connection.php');
   ...
   $conns = $db_con->ConnectToMYSQL();
	...
	$result_company_details = mysqli_query($conns,"SELECT * FROM company_details WHERE company_id = ".$company_id." ");
	 ...
	 $result_product_details = mysqli_query($conns,"SELECT * FROM master_product_item_details_entry WHERE master_finished_product_id = ".$v_master_prod_id." ");
...
<table width="800" border="0" align="center" cellpadding="5" cellspacing="0" id="table_material_list">
  ...
  <?php
          $result_material_list = mysqli_query($conns,"SELECT * FROM master_product_item_details_entry WHERE master_finished_product_id = ".$v_master_prod_id." ");
			$count=1;
			$tot_amount=0;
...
<table width="800" border="0" align="center" cellpadding="5" cellspacing="0" id="table_material_list2">
  ...
  <?php
		 ...
		 $result_product_details = mysqli_query($conns,"SELECT * FROM `master_finished_product_table` WHERE `master_finished_product_id` = ".$v_master_prod_id." ");
...
<script>
   ...
   $(document).ready(function(){
	   $('#print_but').click(function(){
		   ...
		   window.open("pdf/print/master_product_print.php?v_master_prod_id="+v_master_prod_id,"_blank");  
	   });
	   });  
