...
require ('../../model/common/common_functions.php');
   ...
   $conns = $db_con->ConnectToMYSQL();
    ...
    $paise = ($decimal > 0) ? " " . ($words[$decimal / 100] . " " . $words[ $y ]. " " . $words[$decimal % 10]) . ' ' : '';
    return ucwords(($Rupees ? $Rupees . ' ' : ' ') .'1000 /'. $paise ." fills Only  ");
}
          ...
          <tr>
            <td align="left" valign="top" style="padding-top: 0px;"><p><strong> </strong>
              <strong><?PHP echo $company_name; ?></strong><br>
                ...
                <strong>Manama , Bahrain</strong></p>
              </td>
            <td align="left" valign="top">
			  <table width="370px"  cellspacing="0" cellpadding="5">
              <tbody>
                 <tr>
                  <td>PO No : <strong><?PHP echo $invoice_number; ?></strong></td>
                </tr>
                <tr>
                 ...
                 <tr>
                  <td>Payment Terms : <strong><?PHP echo $payment_terms; ?></strong></td>
                </tr>
                <tr>
          ...
          <?PHP 
                ...
                ?>
                          <tr style="border-bottom: 1px solid gray;">
                            ...
                            <td bgcolor="#f2f2f2" style="text-align: right"><?PHP echo ($row['discount_amount']*$row['vat_percentage']/100);$dis_amt=$dis_amt+($row['discount_amount']*$row['vat_percentage']/100);?></td>
                    ...
                    ?>
                        ...
                        <tr style="border-bottom: 1px solid gray;">
                            ...
                            <td style="text-align: right"><?PHP echo ($row['discount_amount']*$row['vat_percentage']/100);$dis_amt=$dis_amt+($row['discount_amount']*$row['vat_percentage']/100);?></td>
