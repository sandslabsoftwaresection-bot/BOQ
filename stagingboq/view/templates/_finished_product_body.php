            ...
            <div class="card">
                ...
                <div class="card-body py-0">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10 ">
                             <h5 class="m-0"> Estimation Details</h5>
                            <hr>
                            <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2" tabindex="3" id="div_main_type_select">
                            ...
                            <div class="form-group row">
                                 <div class="col-lg-12 col-md-12" >
                                     <div   class="row" >
                                          <div class="col-lg-6 col-md-6" id="existing_product" style="display:none;"> 
                                            <label>Product</label>
...
<div id="mySidenavR1" class="sidenavR1 " height="100%" style="background-color:white;padding-top:70px;box-shadow: -10px 0px 10px #e3e3e3;">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0px">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <!--Table-->
                            <table class="table table-striped table-bordered responsive" id="list_of_all_product"  style="padding-top:5px;font-size:12px;width:100%;">
                                <thead>
                                    <tr >
...
<div id="mySidenavR2" class="sidenavR2 " height="100%" style="background-color:white;padding-top:70px;box-shadow: -10px 0px 10px #e3e3e3;">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0px">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <!--Table-->
                            <table class="table table-striped table-bordered nowrap" id="list_of_all_product_item_details"  cellspacing="0"  style="padding-top:5px;font-size:12px;width:100%; diplay:block;">
                                <thead>
                                    <tr >
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0px">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <div class="card-body ">
                          ...
                          <!--Table-->
                            <table class="table table-striped table-bordered nowrap responsive" id="list_of_all_product_item_details_primary"  style="padding-top:5px;font-size:12px;width:100%">
                                <thead>
                                    <tr >
