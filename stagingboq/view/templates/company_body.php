                    ...
                    <div class="media w-100 ">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <!--    <a href="" class="dropdown-item">New</a>-->
                                <button  style="position:relative;bottom:-5px;" class="btn btn-sm btn-outline-light" onclick="openNavR()" id="btn_view_list_of_companies">List of Companies</button>
                        ...
                        <div class="col-md-10 ">
                            <div class="form-group row">
                                <div class="col-lg-8 col-md-8">
                                    <label>Company Name <st style="color:red">*</st></label>
                            ...
                            <div class="form-group row" style="display:none">
                                 <div class="col-lg-4 col-md-6">
                                            ...
                                            <input type="text" id="txt_company_description" class="form-control" placeholder="" value="NA">
                                        
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <label>Email <st style="color:red">*</st></label>
                                    <input type="email" id="txt_contact_email" class="form-control" placeholder="" value="na@gmail.com">
                                </div>
                                <div class="col-lg-3">
                                            <label>PO Box <st style="color:red">*</st></label>
                                            <input type="text" id="txt_contact_address_1" class="form-control" placeholder="" value="NA">
                                        </div>
                                        <div class="col-lg-4">
                                            <label>Fax</label>
                                            <input type="text" id="txt_fax_number" class="form-control" placeholder="" value="NA">
                                        </div>
...
<div id="mySidenavR" class="sidenavR " height="100%" style="background-color:white;padding-top:70px;box-shadow: -10px 0px 10px #e3e3e3;">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0px">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <!--Table-->
                            <table class="table table-striped table-bordered nowrap" id="list_of_companies"  style="padding-top:5px;font-size:12px;width:100%">
                                <thead>
                                    <tr >
