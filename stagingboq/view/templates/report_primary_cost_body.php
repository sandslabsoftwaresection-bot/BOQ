                ...
                <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);">
                    <div class="media w-100 ">
                        ...
                        <div class="media-body">
                            <h5 class="time-title mb-0  text-white">Primary Cost Reports</h5>
                ...
                <div class="card-footer">
                 ...
                 <hr>
                    ...
                    <div class="card rounded-0 border-0 mb-12">
                     <h5 class="m-0">Primary Cost Details</h5>
                     <br/>
                       <div class="form-group row">
                        <div class="col-lg-1 col-md-1">
                            <button class="btn btn-primary btn-xs" id="btn_primary_cost_print"> <i class="material-icons md-22">print</i> </button> 
                        </div> 
                            ...
                            <!--Table-->
                                ...
                                <thead>
                                    <tr >
                                        ...
                                        <th class="text-center" style="font-size:15px">M.Cost</th>
                                        <th class="text-center" style="font-size:15px">L.Cost</th>
                                        
                                        <th class="text-center" style="font-size:15px">S.Cost </th>
                                        
                                        <th class="text-center" style="font-size:15px">E.Cost </th>
                                        
                                        <th class="text-center" style="font-size:15px">O.Cost</th>
                                        
                                        <th class="text-center" style="font-size:15px">Margin</th>
                                        ...
                                        <th class="text-center" style="font-size:15px">View</th>
                                    </tr>
                                </thead>
                                <tbody>
