                ...
                <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);">
                    <div class="media w-100 ">
                        ...
                        <div class="media-body">
                            <h5 class="time-title mb-0  text-white">Material List Reports</h5>
                        ...
                        <div class="col-md-10 ">
                            <div class="form-group row">
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div id="div_company_select_material">
                                    <select class="chosen_select form-control " id="select_company_material" tabindex="1" >
                                ...
                                <div class="col-lg-4 col-md-4">
                                        ...
                                        <div id="div_project_select_material">
                                    
                                    
                                          
                                  
                                           <select class="chosen_select form-control form-control-sm" id="select_project_name_material" tabindex="-1" name="select_project_name_material" >
                               ...
                               <!-- </div>-->
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2" style="padding-top:29px">
                                        <button class="btn btn-info" id="btn_view_material_list"> <i class="material-icons">search</i> </button>
                                    </div>
                            </div>
                ...
                <div class="card-footer">
                 ...
                 <hr>
                    ...
                    <div class="card rounded-0 border-0 mb-12">
                     <h5 class="m-0">Material List Details</h5>
                     <br/>
                        <div class="form-group row">
                        <div class="col-lg-1 col-md-1">
                            <button class="btn btn-primary btn-xs" id="btn_material_list_print"> <i class="material-icons md-22">print</i> </button>
                        </div> 
                        ...
                        <!--        <input type=button id="btn_material_list_excel" onclick="fnExcelReport();" value="export to excel">-->
                        <!--</div>-->
                        <div >
                             
                        
                        <!--Table-->
                            <table class="table table-striped table-bordered dt-responsive nowrap" id="material_list_report"  style="padding-top:5px;font-size:12px;width:100%">
                            <!--Table-->
                                ...
                                <thead>
                                    <tr >
                                       ...
                                       <th class="text-center" style="font-size:15px">VAT</th>
                               ...
                               <tfoot>
                                        ...
                                        <tr>
                                            <th class="text-right" colspan="6">VAT (<span id="vat_prctg"></span>% )</th>
                                            <th class="text-right"></th>
                                        </tr>
                                         <tr>
...
<!-- content page ends -->
    ...
    tab = document.getElementById('material_list_report'); // id of table
